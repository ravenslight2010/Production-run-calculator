...
Generated: 2026-09-02T19:43:21.708Z
Revision: 1ac8ba190253716519e6a288a5a0f7632439e5c9
Mode: standard
...
| --- | --- | ---: | --- |
| production dependency audit | FAIL | 3s | `pnpm run audit:prod` |
...
| recovery evidence audit | PASS | 3s | `pnpm run audit:recovery` |
