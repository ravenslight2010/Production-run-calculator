// Voice input for the "Ask about the day" chat — mobile platform glue.
//
...
// artifacts/run-calculator/src/useSpeechInput.ts (replit.md parity). The only
...
// build there is no JS-only speech API in Expo Go, so `supported` is false and
// the mic button is hidden — graceful fallback to typing.
