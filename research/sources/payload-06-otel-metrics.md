...
Title: Metrics Data Model | OpenTelemetry
Fetched: 2026-09-19T16:07:50.485Z

For AI agents: a documentation index is available at /llms.txt.
This page has a Markdown version at /docs/specs/otel/metrics/data-model/index.md.

# Metrics Data Model

**Status**: [Mixed](https://opentelemetry.io/docs/specs/otel/document-status/)

## Overview [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#overview)
...
## Events => Data Stream => Timeseries [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#events--data-stream--timeseries)
...
### Example Use-cases [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#example-use-cases)
...
### Out of Scope Use-cases [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#out-of-scope-use-cases)
...
## Model Details [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#model-details)
...
- A Metric Stream model, defining the _O_ pen _T_ e _L_ emetry _P_ rotocol (OTLP)
...
### Event Model [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#event-model)

The event model is where recording of data happens. Its foundation is made of
[Instruments](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument), which are used to record data observations via events.
...
in the [metrics API specification](https://opentelemetry.io/docs/specs/otel/metrics/api/).
...
[OpenTelemetry instruments](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument) are detailed in the API
specification.
...
### Timeseries Model [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#timeseries-model)
...
### OpenTelemetry Protocol data model [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#opentelemetry-protocol-data-model)
...
#### OpenTelemetry Protocol data model: Producer recommendations [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#opentelemetry-protocol-data-model-producer-recommendations)
...
#### OpenTelemetry Protocol data model: Consumer recommendations [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#opentelemetry-protocol-data-model-consumer-recommendations)
...
#### Point kinds [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#point-kinds)
...
same kind. [1](https://opentelemetry.io/docs/specs/otel/metrics/data-model/#footnotes)
...
![Stream → Timeseries](https://opentelemetry.io/docs/specs/otel/metrics/img/model-layers-stream.png)
...
## Metric Points [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#metric-points)

**Status**: [Stable](https://opentelemetry.io/docs/specs/otel/document-status/)

Metric points are the basic building blocks of metrics. Depending on the [point\\
kind](https://opentelemetry.io/docs/specs/otel/metrics/data-model/#point-kinds), a metric point may have different fields. The following
sections describe the fields for each point kind and how these points form
metrics.

### Sums [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#sums)
...
loss of generality.  - For delta monotonic sums, this means the reader SHOULD expect non-negative
      values.
...
- A set of data points, each containing:
  ...
  - (optional) a set of exemplars (see [Exemplars](https://opentelemetry.io/docs/specs/otel/metrics/data-model/#exemplars)).
  - (optional) Data point flags (see [Data point flags](https://opentelemetry.io/docs/specs/otel/metrics/data-model/#data-point-flags)).
...
![Delta Sum](https://opentelemetry.io/docs/specs/otel/metrics/img/model-delta-sum.png)
...
![Cumulative Sum](https://opentelemetry.io/docs/specs/otel/metrics/img/model-cumulative-sum.png)
...
### Gauge [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#gauge)
...
![Gauge](https://opentelemetry.io/docs/specs/otel/metrics/img/model-gauge.png)
...
### Histogram [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#histogram)
...
![Delta Histogram](https://opentelemetry.io/docs/specs/otel/metrics/img/model-delta-histogram.png)
...
#### Histogram: Bucket inclusivity [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#histogram-bucket-inclusivity)
...
### ExponentialHistogram [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#exponentialhistogram)
...
[Histogram](https://opentelemetry.io/docs/specs/otel/metrics/data-model/#histogram) data point, used to convey a population of
...
#### Exponential Scale [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#exponential-scale)
...
#### Exponential Buckets [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#exponential-buckets)
...
#### Zero Count and Zero Threshold [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#zero-count-and-zero-threshold)
...
#### Producer Expectations [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#producer-expectations)
...
##### Scale Zero: Extract the Exponent [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#scale-zero-extract-the-exponent)
...
```\
\
##### Negative Scale: Extract and Shift the Exponent [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#negative-scale-extract-and-shift-the-exponent)\
\
...
boundary `0x1p-1024`.\
\
##### All Scales: Use the Logarithm Function [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#all-scales-use-the-logarithm-function)\
\
...
\
01. The exponential base is defined as `base == 2**(2**(-scale))`\
02. We want `index` where `base**index < value <= base**(index+1)`.\
03. Apply the base-`base` logarithm, i.e.,\
    `log_base(base**index) < log_base(value) <= log_base(base**(index+1))` (where `log_X(Y)` indicates the base-`X` logarithm of `Y`)\
04. Rewrite using `log_X(X**Y) == Y`:\
05. Thus, `index < log_base(value) <= index+1`\
06. Using the `Ceiling()` function to simplify the equation: `Ceiling(log_base(value)) == index+1`\
07. Subtract one from each side: `index == Ceiling(log_base(value)) - 1`\
08. Rewrite using `log_X(Y) == log_N(Y) / log_N(X)` to allow use of the natural logarithm\
09. Thus, `index == Ceiling(log(value)/log(base)) - 1`\
...
\
_Note that floating-point to integer type conversions have been_\
_omitted from the code fragments above, to improve readability._\
\
#### ExponentialHistogram: Producer Recommendations [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#exponentialhistogram-producer-recommendations)\
\
...
\
#### ExponentialHistogram: Consumer Recommendations [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#exponentialhistogram-consumer-recommendations)\
\
...
\
#### ExponentialHistogram: Bucket inclusivity [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#exponentialhistogram-bucket-inclusivity)\
\
The [specification on bucket inclusivity made for explicit-boundary\\
Histogram data](https://opentelemetry.io/docs/specs/otel/metrics/data-model/#histogram-bucket-inclusivity) applies equally to\
ExponentialHistogram data.\
\
### Summary (Legacy) [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#summary-legacy)\
\
...
\
## Exemplars [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#exemplars)\
\
**Status**: [Stable](https://opentelemetry.io/docs/specs/otel/document-status/)\
\
...
\
## Data point flags [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#data-point-flags)\
\
**Status**: [Stable](https://opentelemetry.io/docs/specs/otel/document-status/)\
\
...
\
### No recorded value [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#no-recorded-value)\
\
...
\
## Single-Writer [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#single-writer)\
\
**Status**: [Stable](https://opentelemetry.io/docs/specs/otel/document-status/)\
\
...
above.](https://opentelemetry.io/docs/specs/otel/metrics/data-model/#opentelemetry-protocol-data-model-producer-recommendations)\
...
\
## Temporality [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#temporality)\
\
**Status**: [Stable](https://opentelemetry.io/docs/specs/otel/document-status/)\
\
...
## Resets and Gaps [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#resets-and-gaps)
...
### Cumulative streams: handling unknown start time [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#cumulative-streams-handling-unknown-start-time)
...
### Cumulative streams: inserting true reset points [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#cumulative-streams-inserting-true-reset-points)
...
## Overlap [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#overlap)
...
### Overlap resolution [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#overlap-resolution)
...
[process attributes](https://opentelemetry.io/docs/specs/semconv/resource/process/#process)). When there
...
### Overlap observability [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#overlap-observability)
...
### Overlap interpolation [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#overlap-interpolation)
...
## Stream Manipulations [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#stream-manipulations)

**Status**: [Development](https://opentelemetry.io/docs/specs/otel/document-status/)

Pending introduction.

### Sums: Delta-to-Cumulative [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#sums-delta-to-cumulative)
...
a new cumulative stream of data (see [single writer principle](https://opentelemetry.io/docs/specs/otel/metrics/data-model/#single-writer)).
...
- Upon receiving future Delta points, we do the following:
  - If the next point aligns with the expected next-time window
    (see [detecting delta restarts](https://opentelemetry.io/docs/specs/otel/metrics/data-model/#sums-detecting-alignment-issues))
...
#### Sums: detecting alignment issues [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#sums-detecting-alignment-issues)
...
#### Sums: Missing Timestamps [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#sums-missing-timestamps)
...
## References [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#references)

- [OTEP0049 Metric `LabelSet` specification](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.61.0/oteps/metrics/0049-metric-label-set.md)
- [OTEP0113 Integrate Exemplars with Metrics](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.61.0/oteps/metrics/0113-exemplars.md)
- [OTEP0146 Scenarios for Metrics API/SDK Prototyping](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.61.0/oteps/metrics/0146-metrics-prototype-scenarios.md)

## Footnotes [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/data-model/\#footnotes)
