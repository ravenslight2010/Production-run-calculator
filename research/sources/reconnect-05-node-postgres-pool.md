Source: https://node-postgres.com/guides/pool-sizing
Title: node-postgres
Fetched: 2026-09-19T16:08:11.851Z

[guides](https://node-postgres.com/guides/project-structure "guides") Pool Sizing

If you’re using a [pool](https://node-postgres.com/apis/pool) in an application with multiple instances of your service running (common in most cloud/container environments currently), you’ll need to think a bit about the `max` parameter of your pool across all services and all _instances_ of all services which are connecting to your Postgres server.
...
## Simple apps, dev mode, fixed instance counts, etc. [Permalink for this section](https://node-postgres.com/guides/pool-sizing\#simple-apps-dev-mode-fixed-instance-counts-etc)
...
## Auto-scaling, cloud-functions, multi-tenancy, etc. [Permalink for this section](https://node-postgres.com/guides/pool-sizing\#auto-scaling-cloud-functions-multi-tenancy-etc)
...
### Vercel [Permalink for this section](https://node-postgres.com/guides/pool-sizing\#vercel)
...
### Cloudflare workers [Permalink for this section](https://node-postgres.com/guides/pool-sizing\#cloudflare-workers)
...
## pg-bouncer, RDS-proxy, etc. [Permalink for this section](https://node-postgres.com/guides/pool-sizing\#pg-bouncer-rds-proxy-etc)
...
## Conclusion, tl;dr [Permalink for this section](https://node-postgres.com/guides/pool-sizing\#conclusion-tldr)
...
## Need help? [Permalink for this section](https://node-postgres.com/guides/pool-sizing\#need-help)
...
[Express with Async/Await](https://node-postgres.com/guides/async-express "Express with Async/Await") [Upgrading](https://node-postgres.com/guides/upgrading "Upgrading")