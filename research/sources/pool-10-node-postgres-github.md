Source: https://github.com/brianc/node-postgres/blob/master/docs/pages/guides/pool-sizing.md
Title: node-postgres/docs/pages/guides/pool-sizing.md at master · brianc/node-postgres · GitHub
Fetched: 2026-09-19T16:08:14.325Z

[Skip to content](https://github.com/brianc/node-postgres/blob/master/docs/pages/guides/pool-sizing.md#start-of-content)

You signed in with another tab or window. [Reload](https://github.com/brianc/node-postgres/blob/master/docs/pages/guides/pool-sizing.md) to refresh your session.You signed out in another tab or window. [Reload](https://github.com/brianc/node-postgres/blob/master/docs/pages/guides/pool-sizing.md) to refresh your session.You switched accounts on another tab or window. [Reload](https://github.com/brianc/node-postgres/blob/master/docs/pages/guides/pool-sizing.md) to refresh your session.Dismiss alert

{{ message }}

[brianc](https://github.com/brianc)/ **[node-postgres](https://github.com/brianc/node-postgres)** Public

- [Sponsor](https://github.com/sponsors/brianc)
- [Notifications](https://github.com/login?return_to=%2Fbrianc%2Fnode-postgres) You must be signed in to change notification settings
- [Fork\\
1.4k](https://github.com/login?return_to=%2Fbrianc%2Fnode-postgres)
- [Star\\
13.2k](https://github.com/login?return_to=%2Fbrianc%2Fnode-postgres)
...
[![brianc](https://avatars.githubusercontent.com/u/50081?v=4&size=40)](https://github.com/brianc)[brianc](https://github.com/brianc/node-postgres/commits?author=brianc)

[Docs updates (](https://github.com/brianc/node-postgres/commit/c6028a875f953eff9e8e403622b0aac127d1b4a6) [#3622](https://github.com/brianc/node-postgres/pull/3622) [)](https://github.com/brianc/node-postgres/commit/c6028a875f953eff9e8e403622b0aac127d1b4a6)

Open commit detailssuccess

7 months agoMar 5, 2026

[c6028a8](https://github.com/brianc/node-postgres/commit/c6028a875f953eff9e8e403622b0aac127d1b4a6) · 7 months agoMar 5, 2026

## History

[History](https://github.com/brianc/node-postgres/commits/master/docs/pages/guides/pool-sizing.md)

Open commit details

[View commit history for this file.](https://github.com/brianc/node-postgres/commits/master/docs/pages/guides/pool-sizing.md) History

37 lines (20 loc) · 5.92 KB
...
[Raw](https://github.com/brianc/node-postgres/raw/refs/heads/master/docs/pages/guides/pool-sizing.md)
...
If you're using a [pool](https://github.com/brianc/node-postgres/blob/master/apis/pool) in an application with multiple instances of your service running (common in most cloud/container environments currently), you'll need to think a bit about the `max` parameter of your pool across all services and all _instances_ of all services which are connecting to your Postgres server.
...
[Permalink: Simple apps, dev mode, fixed instance counts, etc.](https://github.com/brianc/node-postgres/blob/master/docs/pages/guides/pool-sizing.md#simple-apps-dev-mode-fixed-instance-counts-etc)
...
[Permalink: Auto-scaling, cloud-functions, multi-tenancy, etc.](https://github.com/brianc/node-postgres/blob/master/docs/pages/guides/pool-sizing.md#auto-scaling-cloud-functions-multi-tenancy-etc)
...
[Permalink: Vercel](https://github.com/brianc/node-postgres/blob/master/docs/pages/guides/pool-sizing.md#vercel)
...
[Permalink: Cloudflare workers](https://github.com/brianc/node-postgres/blob/master/docs/pages/guides/pool-sizing.md#cloudflare-workers)
...
[Permalink: pg-bouncer, RDS-proxy, etc.](https://github.com/brianc/node-postgres/blob/master/docs/pages/guides/pool-sizing.md#pg-bouncer-rds-proxy-etc)
...
[Permalink: Conclusion, tl;dr](https://github.com/brianc/node-postgres/blob/master/docs/pages/guides/pool-sizing.md#conclusion-tldr)
...
[Permalink: Need help?](https://github.com/brianc/node-postgres/blob/master/docs/pages/guides/pool-sizing.md#need-help)
