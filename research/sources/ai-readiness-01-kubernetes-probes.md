...
Fetched: 2026-09-19T16:07:30.252Z
...
by the [kubelet](https://kubernetes.io/docs/reference/command-line-tools-reference/kubelet) on a container.
...
## Types of probe [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#types-of-probe)

The kubelet can optionally perform and react to three kinds of probes on running
containers, each serving a different purpose:

- [Startup probe](https://kubernetes.io/docs/concepts/workloads/pods/probes/#startup-probe)
- [Liveness probe](https://kubernetes.io/docs/concepts/workloads/pods/probes/#liveness-probe)
- [Readiness probe](https://kubernetes.io/docs/concepts/workloads/pods/probes/#readiness-probe)

### Startup probe [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#startup-probe)
...
### Liveness probe [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#liveness-probe)
...
`initialDelaySeconds` or use a [startup probe](https://kubernetes.io/docs/concepts/workloads/pods/probes/#startup-probe).
...
### Readiness probe [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#readiness-probe)
...
regular traffic. See [Pod termination](https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/#pod-termination)
for more information about how the kubelet handles Pod deletion.

## When to use each probe [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#when-to-use-each-probe)

### When should you use a startup probe? [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#when-should-you-use-a-startup-probe)
...
initialDelaySeconds+failureThreshold×periodSeconds initialDelaySeconds + failureThreshold \\times periodSeconds initialDelaySeconds+failureThreshold×periodSeconds, you should specify a
...
### When should you use a liveness probe? [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#when-should-you-use-a-liveness-probe)
...
### When should you use a readiness probe? [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#when-should-you-use-a-readiness-probe)
...
migrations during startup, consider using a [startup probe](https://kubernetes.io/docs/concepts/workloads/pods/probes/#startup-probe).
...
## Check mechanisms [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#check-mechanisms)
...
considered successful if the command exits with a status code of 0.`grpc`Performs a remote procedure call using [gRPC](https://grpc.io/). The target
...
`SERVING`. For more details, see [gRPC probes](https://kubernetes.io/docs/concepts/workloads/pods/probes/#grpc-probes).`httpGet`Performs an HTTP `GET` request against the Pod's IP address on a specified
...
For more details, see [HTTP probes](https://kubernetes.io/docs/concepts/workloads/pods/probes/#http-probes).`tcpSocket`Performs a TCP check against the Pod's IP address on a specified port. The
...
as healthy.
For more details, see [TCP probes](https://kubernetes.io/docs/concepts/workloads/pods/probes/#tcp-probes).
...
## Probe results [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#probe-results)

The kubelet evaluates the result of each probe execution and takes action
accordingly. Each probe has one of three results:

`Success`The container passed the diagnostic.`Failure`The container failed the diagnostic. For liveness and startup probes, the
...
Pod stops receiving traffic from matching Services.`Unknown`The diagnostic failed (no action should be taken, and the kubelet will make
further checks).
...
## Configuration fields [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#configure-probes)

[Probes](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#probe-v1-core)
...
### Probe-level `terminationGracePeriodSeconds` [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#probe-level-terminationgraceperiodseconds)
...
## Probe mechanism details [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#probe-mechanism-details)

### HTTP probes [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#http-probes)

[HTTP probes](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#httpgetaction-v1-core)
...
`H2CContainerProbe` [feature gate](https://kubernetes.io/docs/reference/command-line-tools-reference/feature-gates/)
to be enabled.
...
- `User-Agent`, which defaults to `kube-probe/1.37`
where `1.37` is the version of the kubelet.
...
#### Redirect handling [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#http-probes-redirects)
...
### TCP probes [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#tcp-probes)
...
### gRPC probes [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#grpc-probes)
...
[`pods/probe/grpc-liveness.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/pods/probe/grpc-liveness.yaml)![](https://kubernetes.io/images/copycode.svg)
...
## What's next [Heading self-link](https://kubernetes.io/docs/concepts/workloads/pods/probes/\#what-s-next)
...
[report a problem](https://github.com/kubernetes/website/issues/new?title=Issue%20with%20k8s.io/docs/concepts/workloads/pods/probes/)
or
[suggest an improvement](https://github.com/kubernetes/website/issues/new?title=Improvement%20for%20k8s.io/docs/concepts/workloads/pods/probes/).
