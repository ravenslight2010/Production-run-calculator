...
- Cheese/mix renames are deliberately NOT learned as aliases: their name namespace doubles as the applicator blend-type namespace, where a prepare-time rename can silently disconnect slots.
