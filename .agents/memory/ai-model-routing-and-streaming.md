...
- Models: both tiers currently = `gemini-3.1-pro-preview` (see `src/models.ts`, the only source of truth). Preview/pro models add a harmless `thoughtSignature` on parts.
