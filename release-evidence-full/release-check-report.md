...
Generated: 2026-08-27T10:42:59.107Z
Revision: 2b6cb5a3b25a2a8953d9eb6fc584203f94d86cba
Mode: full
...
| clean-start smoke | PASS | 24s | `pnpm run check:clean-start` |
| API unit tests (release shard 1/6) | PASS | 51s | `pnpm --filter @workspace/api-server run test:release:unit` |
| API integration tests (release shard 2/6) | PASS | 264s | `pnpm --filter @workspace/api-server run test:release:integration:1` |
| API integration tests (release shard 3/6) | PASS | 230s | `pnpm --filter @workspace/api-server run test:release:integration:2` |
...
| API sync tests (release shard 5/6) | PASS | 62s | `pnpm --filter @workspace/api-server run test:release:sync` |
