...
Generated: 2026-08-28T09:49:41.843Z
Revision: a7de6c21db06b99d4d010334f6e097d77aaa9fbb
Mode: full
...
| API integration tests (release shard 2/6) | PASS | 204s | `pnpm --filter @workspace/api-server run test:release:integration:1` |
| API integration tests (release shard 3/6) | PASS | 181s | `pnpm --filter @workspace/api-server run test:release:integration:2` |
...
| API sync tests (release shard 5/6) | PASS | 68s | `pnpm --filter @workspace/api-server run test:release:sync` |
| API sync SSE tests (release shard 6/6) | PASS | 25s | `pnpm --filter @workspace/api-server run test:release:sync-sse` |
