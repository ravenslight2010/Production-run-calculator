...
const MENU_ITEMS: {
  ...
  { label: "Password", icon: "key", route: "/password", desc: "Change your password" },
];
  ...
  return (
    <>
      ...
      >
        ...
        <Tabs.Screen name="password" options={{ href: null, title: "Password" }} />
          ...
          >
            ...
            {MENU_ITEMS.map((item) => (
              ...
              >
                ...
                {item.route === "/settings" && pendingResetCount > 0 && (
                  <View
                    style={[
                      styles.menuBadge,
                      { backgroundColor: colors.warning ?? colors.primary },
