...
export default function ScheduleScreen() {
  ...
  // Dev-only browser test hook (shared with Summary + Master Data — see
  // utils/devTestImport.ts): commits a staged ImportCommit from localStorage
  // "rc_test_import" through the SAME commitImport path as the file picker.
  useDevTestImport({ screen: "schedule", allRuns, today, commit: commitImport });
