...
import { SaveFacilityKnowledgeBody } from "@workspace/api-zod";
...
// Shared facility-memory HTTP surface. The facility pool is factory-wide and gets folded into
...
//   - Writing stays reachable by ordinary staff accounts for quality-check
//     confirmation, which is `use-ai-tools`-gated client-side and enforced
//     again here. Every entry
...
// writes facility knowledge directly (InventoryTab.tsx quality-check confirm)
// — that call site must be
