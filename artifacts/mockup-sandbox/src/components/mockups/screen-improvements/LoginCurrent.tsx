...
export function LoginCurrent() {
  return (
    <div className="dark flex min-h-screen flex-col items-center justify-center bg-background text-foreground px-6 py-12 text-center">
      {/* Logo block */}
      <div className="mx-auto mb-6 h-20 w-20 rounded-2xl bg-card shadow-lg flex items-center justify-center">
      ...
      {/* Card */}
      <div className="mt-8 w-full max-w-sm overflow-hidden rounded-2xl border border-border/50 bg-card/50 shadow-md">
        {/* The current amber divider - flat line at card top */}
        <div className="h-1 w-full bg-amber-500/70" />
        <div className="flex flex-col gap-3 p-6">
          <button className="w-full rounded-lg bg-amber-500 px-4 py-3 text-sm font-semibold text-black">
            Sign in
          </button>
